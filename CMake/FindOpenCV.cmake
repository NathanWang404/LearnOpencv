...
if (WIN32)
    set(opencv_path ${CMAKE_SOURCE_DIR}/ThirdParty/Opencv/win32)
elseif (APPLE)
    set(opencv_path ${CMAKE_SOURCE_DIR}/ThirdParty/Opencv/mac64/lib/cmake/opencv4)
endif ()
find_path(OpenCV_DIR "OpenCVConfig.cmake" ${opencv_path} DOC "Root directory of OpenCV")
